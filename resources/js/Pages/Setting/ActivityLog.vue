...
<template>
    <Head :title="t('pages.activity_log')" />
        ...
        <div class="border-t-[3px] border-t-blue-600 border-x border-b border-slate-200 dark:border-slate-700/80 bg-white dark:bg-slate-800 rounded shadow-sm overflow-hidden mb-8">
            ...
            <div class="px-5 py-3 border-b border-slate-200 dark:border-slate-700 flex justify-between items-center bg-[#f8f9fa] dark:bg-[#242434]">
                ...
                <div class="flex items-center gap-2">
                    <Link
                        :href="route('trash.list')"
                        class="bg-[#dc3545] hover:bg-[#c82333] text-white font-semibold rounded px-3 py-1.5 text-xs transition-colors duration-150 inline-flex items-center gap-1"
                    >
            ...
            <div v-show="!isFilterCollapsed" class="p-5 border-b border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-900/30 transition-all duration-300">
                <form @submit.prevent="filterLogs" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4 items-end">
                    ...
                    <div class="flex gap-2 w-full">
                        <button
                            type="submit"
                            class="flex-1 bg-[#007bff] hover:bg-[#0069d9] text-white font-semibold rounded py-2 text-xs transition duration-150 inline-flex items-center justify-center gap-1"
                        >
                        ...
                        <tbody class="divide-y divide-slate-200/60 dark:divide-slate-700/40 text-slate-700 dark:text-slate-200">
                            ...
                            >
                                ...
                                <td class="p-3 border-r border-slate-200 dark:border-slate-700/60 font-medium">
                                    <!-- Create -->
                                    <span v-if="log.event === 'Create'" class="inline-flex items-center gap-1 text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/20 px-2 py-0.5 rounded text-xs font-semibold border border-emerald-200/55 dark:border-emerald-900/30">
                                    ...
                                    <!-- Update -->
                                    <span v-else-if="log.event === 'Update'" class="inline-flex items-center gap-1 text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-950/20 px-2 py-0.5 rounded text-xs font-semibold border border-blue-200/55 dark:border-blue-900/30">
                                    ...
                                    <!-- SoftDelete / Delete -->
                                    <span v-else-if="log.event === 'SoftDelete' || log.event === 'Delete'" class="inline-flex items-center gap-1 text-rose-600 dark:text-rose-400 bg-rose-50 dark:bg-rose-950/20 px-2 py-0.5 rounded text-xs font-semibold border border-rose-200/55 dark:border-rose-900/30">
                                        <svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                                    ...
                                    <!-- Restore -->
                                    <span v-else-if="log.event === 'Restore'" class="inline-flex items-center gap-1 text-teal-600 dark:text-teal-400 bg-teal-50 dark:bg-teal-950/20 px-2 py-0.5 rounded text-xs font-semibold border border-teal-200/55 dark:border-teal-900/30">
                                        <svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                                    ...
                                    <!-- Default Info -->
                                    <span v-else class="inline-flex items-center gap-1 text-slate-600 dark:text-slate-400 bg-slate-50 dark:bg-slate-950/20 px-2 py-0.5 rounded text-xs font-semibold border border-slate-200/55 dark:border-slate-900/30">
                                ...
                                <td class="p-3 text-right">
                                    <a
                                        v-if="log.generated_route !== '#'"
                                        :href="log.generated_route"
                                        target="_blank"
